class OrderOrderhistory
  ...
  def save
    ...
    # 住所を保存する
    OrderHistory.create(post_cord: post_cord, prefecture_id: prefecture_id, municipality: municipality, address: address, phone_number: phone_number, building_name: building_name, order_id: order.id)
  end
end